...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    :root[data-theme="dark"] .langseg button.on{background:#25ff86;color:#0a0e0a}
...
<body>
  ...
  const APP_VERSION = '0.5.6'; // shown in the footer; bump on release
  ...
  const TH = {
    ...
    // === batch1: nav / guide / platform / home ===
    '中':'จีน', '深色 / 浅色':'มืด / สว่าง', '赞助商':'ผู้สนับสนุน', '主办方':'ผู้จัดงาน',
    '指南':'คู่มือ', '价格':'ราคา', '媒体':'สื่อ', '我组织的黑客松':'แฮกกาธอนที่ฉันจัด',
    '我的设置':'การตั้งค่าของฉัน', '运营':'ผู้ดูแลระบบ', '发起黑客松':'เริ่มจัดแฮกกาธอน',
    '排行榜':'อันดับคะแนน', '评审入口':'เข้าสู่การตัดสิน', '页面不存在。':'ไม่พบหน้านี้',
    '这是一场受邀的私密黑客松,请输入主办方发给你的访问码。':'นี่คือแฮกกาธอนส่วนตัวแบบเชิญ กรุณากรอกรหัสเข้าถึงที่ผู้จัดส่งให้คุณ',
    '访问码':'รหัสเข้าถึง', '进入':'เข้าสู่', '请输入访问码':'กรุณากรอกรหัสเข้าถึง', '验证中…':'กำลังตรวจสอบ…',
    '第一次参加黑客松?读《如何在 AI 时代成为创新者》':'ครั้งแรกกับแฮกกาธอน? อ่าน《การเป็นนักสร้างสรรค์ในยุค AI》',
    '还没有作品,':'ยังไม่มีผลงาน ', '。':'',
    '注册 GitHub,建一个仓库':'สมัคร GitHub แล้วสร้างที่เก็บโค้ด',
    '这是你作品的家:代码、README、演示,全放这里。':'ที่นี่คือบ้านของผลงานคุณ: โค้ด README เดโม อยู่ที่นี่ทั้งหมด',
    '选一个免费的 AI 开发工具':'เลือกเครื่องมือพัฒนา AI ฟรีสักตัว',
    '让 AI 帮你写代码、调试、部署;你负责想法和判断。':'ให้ AI ช่วยเขียนโค้ด ดีบัก ดีพลอย ส่วนคุณดูแลไอเดียและการตัดสินใจ',
    '说出想法,几小时做出来,push 上线':'บอกไอเดีย สร้างในไม่กี่ชั่วโมง แล้ว push ขึ้นออนไลน์',
    '别等完美,先让它跑起来 —— 这就是黑客精神。':'อย่ารอให้สมบูรณ์แบบ ทำให้มันรันก่อน — นี่แหละจิตวิญญาณแฮกเกอร์',
    '独立域名站点':'เว็บไซต์โดเมนของตัวเอง',
    '每场黑客松一个 name.hack5.net,专业又好记。':'แต่ละแฮกกาธอนได้ name.hack5.net ดูมืออาชีพและจำง่าย',
    '选手交 GitHub 链接,自动抓 star/语言/README 生成作品卡。':'ผู้เข้าแข่งส่งลิงก์ GitHub ระบบดึง star/ภาษา/README มาสร้างการ์ดผลงานอัตโนมัติ',
    '活动首页 + 地图':'หน้าแรกงาน + แผนที่',
    '介绍、时间地点、周期,内嵌地图(自动适配国内外)。':'แนะนำ เวลา สถานที่ ระยะเวลา พร้อมแผนที่ฝังในตัว',
    '现场花絮瀑布流,上传自动压缩。':'ภาพบรรยากาศงานแบบน้ำตก อัปโหลดแล้วบีบอัดอัตโนมัติ',
    '在线评审':'การตัดสินออนไลน์',
    '评委登录码、四维打分、排行榜、CSV 导出、锁定评审版本。':'รหัสเข้าสำหรับกรรมการ ให้คะแนน 4 มิติ อันดับ ส่งออก CSV ล็อกเวอร์ชันตัดสิน',
    '首场免费':'งานแรกฟรี',
    '第一场黑客松免费,记录永久保留;更多场次与高级功能可订阅。':'แฮกกาธอนงานแรกฟรี เก็บบันทึกถาวร งานเพิ่มและฟีเจอร์ขั้นสูงสมัครสมาชิกได้',
    '邮箱登录(无需注册)':'เข้าสู่ระบบด้วยอีเมล (ไม่ต้องสมัคร)',
    '输入邮箱,收验证码即登录。':'กรอกอีเมล รับรหัสยืนยันแล้วเข้าสู่ระบบได้เลย',
    '取名,拿到你的域名':'ตั้งชื่อ แล้วรับโดเมนของคุณ',
    '给黑客松取个名字,自动分配 name.hack5.net。':'ตั้งชื่อแฮกกาธอน ระบบจัดสรร name.hack5.net อัตโนมัติ',
    '一键部署,开始招募':'ดีพลอยคลิกเดียว เริ่มรับสมัคร',
    '拿到管理员密码,发邀请码给选手、登录码给评委。':'รับรหัสผู้ดูแล ส่งรหัสเชิญให้ผู้เข้าแข่ง และรหัสเข้าให้กรรมการ',
    '如何成为一名黑客':'จะเป็นแฮกเกอร์ได้อย่างไร', '—— 做 AI 时代的创新者':'— เป็นนักสร้างสรรค์แห่งยุค AI',
    '时代变了':'ยุคสมัยเปลี่ยนไปแล้ว',
    '从一个想法到一个能用的产品,过去要几个月甚至几年;现在被压缩到几天、甚至几个小时。AI 帮你写代码、调试、部署,创造的门槛前所未有地低。问题不再是「你会不会写代码」,而是「你有没有想法,敢不敢现在就动手」。':'จากไอเดียสู่ผลิตภัณฑ์ที่ใช้ได้จริง เมื่อก่อนใช้เวลาหลายเดือนหรือเป็นปี ตอนนี้ย่นเหลือไม่กี่วันหรือไม่กี่ชั่วโมง AI ช่วยเขียนโค้ด ดีบัก ดีพลอย ทำให้กำแพงของการสร้างต่ำอย่างที่ไม่เคยมีมาก่อน คำถามไม่ใช่「คุณเขียนโค้ดเป็นไหม」แต่เป็น「คุณมีไอเดียไหม กล้าลงมือตอนนี้หรือเปล่า」',
    '为什么参加黑客松':'ทำไมต้องเข้าร่วมแฮกกาธอน',
    '黑客松是最好的练习场:在真实的时间压力下,逼自己把想法变成能跑的东西。它更是一个圈子 —— 你会遇到志同道合的伙伴,被高手推着学新技能,拿到真实反馈,甚至认识未来的合伙人和投资人。一个周末,可能就改变你的轨迹。':'แฮกกาธอนคือสนามฝึกที่ดีที่สุด: ภายใต้แรงกดดันด้านเวลาจริง คุณจะบังคับตัวเองเปลี่ยนไอเดียให้เป็นสิ่งที่รันได้ และมันยังเป็นคอมมิวนิตี้ — คุณจะเจอเพื่อนที่คิดเหมือนกัน ถูกผลักดันให้เรียนทักษะใหม่ ได้ฟีดแบ็กจริง แม้กระทั่งเจอหุ้นส่วนและนักลงทุนในอนาคต สุดสัปดาห์เดียวอาจเปลี่ยนเส้นทางของคุณ',
    '三步开始':'เริ่มใน 3 ขั้นตอน', '准备好动手了吗?':'พร้อมลงมือหรือยัง?',
    '👀 看一个示例黑客松 →':'👀 ดูตัวอย่างแฮกกาธอน →',
    '如何组织一场黑客松':'จะจัดแฮกกาธอนอย่างไร',
    ...
    '启动 →':'เริ่ม →', '10 分钟启动 · 邀请制':'เริ่มใน 10 นาที · แบบเชิญ',
    '访问码门禁、不公开源码、Demo 评审。付费。':'ล็อกด้วยรหัสเข้าถึง ไม่เปิดซอร์ส ตัดสินจากเดโม แบบเสียเงิน',
    '5 分钟启动 · AI 驱动 · 50 人以下':'เริ่มใน 5 นาที · ขับเคลื่อนด้วย AI · ไม่เกิน 50 คน',
    '面向非开发者:AI 驱动,一句想法就能自动做成能跑的应用。每人 1 次免费。':'สำหรับผู้ที่ไม่ใช่นักพัฒนา: ขับเคลื่อนด้วย AI แค่ไอเดียประโยคเดียวก็สร้างเป็นแอปที่รันได้อัตโนมัติ ฟรีคนละ 1 ครั้ง',
    '👀 看 Demo 示例 → demo.hack5.net':'👀 ดูตัวอย่างเดโม → demo.hack5.net',
    '黑客松不存在':'ไม่พบแฮกกาธอน', '这个地址还没有对应的黑客松。':'ยังไม่มีแฮกกาธอนที่อยู่นี้',
    '去 hack5.net 发起一个 →':'ไปเริ่มที่ hack5.net →',
    '发起你的黑客松':'เริ่มแฮกกาธอนของคุณ',
    '输入邮箱,用验证码登录 —— 无需注册':'กรอกอีเมล เข้าสู่ระบบด้วยรหัสยืนยัน — ไม่ต้องสมัคร',
    '验证码':'รหัสยืนยัน', '6 位验证码':'รหัสยืนยัน 6 หลัก', '发送验证码':'ส่งรหัสยืนยัน',
    '登录':'เข้าสู่ระบบ', '发送中…':'กำลังส่ง…', '验证码已发送,请查收邮箱。':'ส่งรหัสยืนยันแล้ว กรุณาเช็กอีเมล',
    ...
    '邀请制、访问码门禁、不公开源码、Demo 评审。适合企业内部赛与命题赛。':'แบบเชิญ ล็อกด้วยรหัสเข้าถึง ไม่เปิดซอร์ส ตัดสินจากเดโม เหมาะกับการแข่งภายในองค์กรและโจทย์เฉพาะ',
    '访问码门禁 + 会话时效':'ล็อกด้วยรหัสเข้าถึง + เซสชันมีอายุ', '评委作为协作者评估私有代码':'กรรมการเป็นผู้ร่วมงานเพื่อประเมินโค้ดส่วนตัว',
    '一口价,按场购买':'ราคาเดียว ซื้อต่องาน', '按场':'ต่องาน', '购买后即用':'ใช้ได้ทันทีหลังซื้อ', '购买':'ซื้อ',
    ...
    '无法读取图片':'อ่านรูปไม่ได้', '我的设置 · 组织资料':'การตั้งค่าของฉัน · ข้อมูลองค์กร',
    '你的主办方身份,会显示在你创建的每个黑客松页面底部(主办方:…),跨所有活动复用。':'ตัวตนผู้จัดของคุณจะแสดงที่ท้ายทุกหน้าแฮกกาธอนที่คุณสร้าง (ผู้จัดงาน:…) ใช้ซ้ำได้ทุกงาน',
    '组织名称':'ชื่อองค์กร', '组织简介':'แนะนำองค์กร', '组织网址':'เว็บไซต์องค์กร', '对外联系方式':'ช่องทางติดต่อ',
    '邮箱 / 微信 / Telegram':'อีเมล / WeChat / Telegram', 'PNG 透明,自动裁为 180×180':'PNG โปร่งใส ครอปอัตโนมัติเป็น 180×180',
    '移除':'ลบออก', '保存':'บันทึก', '无':'ไม่มี', 'Logo 已就绪,记得点保存':'โลโก้พร้อมแล้ว อย่าลืมกดบันทึก', '已保存 ✓':'บันทึกแล้ว ✓',
    '✨ Mini(5 分钟)':'✨ Mini (5 นาที)', '🔒 企业私密':'🔒 องค์กรส่วนตัว', '⚡ 常规':'⚡ ทั่วไป', '已用':'ใช้ไปแล้ว',
    '转发':'ส่งต่อ', '进入 →':'เข้าสู่ →', '还没有黑客松,创建第一个 👇':'ยังไม่มีแฮกกาธอน สร้างงานแรกเลย 👇',
    '创建新黑客松':'สร้างแฮกกาธอนใหม่', '模式':'โหมด', '换常规':'เปลี่ยนเป็นทั่วไป', '名称':'ชื่อ', '例:上海 2026 黑客松':'เช่น แฮกกาธอนเชียงใหม่ 2026',
    '子域名':'ซับโดเมน', '(可选)':'(ไม่บังคับ)', '这是一场关于…的 mini 黑客松':'นี่คือแฮกกาธอน mini เกี่ยวกับ…',
    '黑客松简介':'แนะนำแฮกกาธอน', '(会显示在首页,至少 10 字)':'(แสดงที่หน้าแรก อย่างน้อย 10 ตัวอักษร)',
    '这是一场关于…的黑客松,面向…':'นี่คือแฮกกาธอนเกี่ยวกับ… สำหรับ…', '首页 Banner 图':'ภาพแบนเนอร์หน้าแรก',
    '(可选,不传给默认款)':'(ไม่บังคับ ไม่ใส่จะใช้แบบเริ่มต้น)', '🔒 私密 / 企业模式':'🔒 โหมดส่วนตัว / องค์กร',
    '访问有效期(天)':'อายุการเข้าถึง (วัน)', '✨ 5 分钟创建':'✨ สร้างใน 5 นาที', '创建并部署':'สร้างและดีพลอย',
    '已达免费额度。充值 ¥99 可举办 100 场。':'ใช้โควตาฟรีหมดแล้ว เติม ¥99 จัดได้ 100 งาน', '充值 ¥99':'เติม ¥99',
    '图片处理失败':'ประมวลผลรูปไม่สำเร็จ', '请填写名称':'กรุณากรอกชื่อ', '请填写子域名':'กรุณากรอกซับโดเมน',
    '请写至少 10 字的简介':'กรุณาเขียนแนะนำอย่างน้อย 10 ตัวอักษร', '创建中…':'กำลังสร้าง…', '创建成功!':'สร้างสำเร็จ!',
    '站点':'เว็บไซต์', '管理员密码':'รหัสผู้ดูแล', '复制':'คัดลอก', '只显示这一次,请立即复制保存。':'แสดงครั้งเดียวเท่านั้น กรุณาคัดลอกเก็บไว้ทันที',
    '已复制':'คัดลอกแล้ว', '复制这个密码':'คัดลอกรหัสนี้', ' 秒后自动进入你的黑客松站点…':' วินาทีจะเข้าสู่เว็บแฮกกาธอนของคุณอัตโนมัติ…',
    '在地图打开':'เปิดในแผนที่', '高德':'AutoNavi', '百度':'Baidu', '日程 · Agenda':'กำหนดการ · Agenda', '首页设置':'ตั้งค่าหน้าแรก',
    '介绍':'แนะนำ', '这个黑客松是关于…':'แฮกกาธอนนี้เกี่ยวกับ…', '首页 Banner':'แบนเนอร์หน้าแรก',
    '(宽幅,自动裁 ~2.9:1 并压 ≤120KB;不设则用默认款)':'(แนวกว้าง ครอปอัตโนมัติ ~2.9:1 และบีบ ≤120KB ไม่ตั้งจะใช้แบบเริ่มต้น)',
    '时间':'เวลา', '例:2026-08-15 ~ 08-17':'เช่น 2026-08-15 ~ 08-17', '地点':'สถานที่', '例:上海·徐汇':'เช่น เชียงใหม่·นิมมาน',
    '持续周期':'ระยะเวลา', '例:48 小时':'เช่น 48 ชั่วโมง', '地址(用于地图)':'ที่อยู่ (สำหรับแผนที่)', '街道地址':'ที่อยู่ถนน',
    '地图搜索词':'คำค้นแผนที่', '(留空则用地址)':'(เว้นว่างจะใช้ที่อยู่)', '日程':'กำหนดการ', '(每行一项:时间 | 内容)':'(บรรทัดละรายการ: เวลา | เนื้อหา)',
    'Day 1 09:00 | 开幕\nDay 1 10:00 | 开始开发\nDay 2 14:00 | Demo\nDay 2 16:00 | 颁奖':'Day 1 09:00 | พิธีเปิด\nDay 1 10:00 | เริ่มพัฒนา\nDay 2 14:00 | เดโม\nDay 2 16:00 | มอบรางวัล',
    '返回':'กลับ', '处理中…':'กำลังประมวลผล…', 'Banner 已更新 ✓':'อัปเดตแบนเนอร์แล้ว ✓', '黑客松现场花絮':'ภาพบรรยากาศงานแฮกกาธอน',
    '上传照片':'อัปโหลดรูป', '建议至少 5 张,自动压缩到 120KB 以内':'แนะนำอย่างน้อย 5 รูป บีบอัดอัตโนมัติไม่เกิน 120KB', '上传':'อัปโหลด',
    '一次最多 40 张':'สูงสุด 40 รูปต่อครั้ง', '请先选择照片':'กรุณาเลือกรูปก่อน', '上传中…':'กำลังอัปโหลด…', '已上传 ':'อัปโหลดแล้ว ',
    '还没有照片':'ยังไม่มีรูป', '删除这张?':'ลบรูปนี้?', '不是图片':'ไม่ใช่รูปภาพ', '图片太大,换一张':'รูปใหญ่เกินไป เปลี่ยนรูป', '无法读取':'อ่านไม่ได้',
    '报名 · 提交作品':'ลงทะเบียน · ส่งผลงาน', '已复制 ✓':'คัดลอกแล้ว ✓', '复制失败,请手动选择':'คัดลอกไม่สำเร็จ กรุณาเลือกเอง',
    '报名 / 提交作品:':'ลงทะเบียน / ส่งผลงาน:', '一键转发':'ส่งต่อคลิกเดียว',
    '下面是自动生成的海报和文案。复制文案 + 下载海报,发到公众号 / 小红书 / 微信群 / Telegram 群;手机可直接用系统分享。':'ด้านล่างคือโปสเตอร์และข้อความที่สร้างอัตโนมัติ คัดลอกข้อความ + ดาวน์โหลดโปสเตอร์ แล้วโพสต์ไปยังโซเชียล / กลุ่ม WeChat / กลุ่ม Telegram บนมือถือใช้แชร์ของระบบได้เลย',
    '🎨 换成 AI 定制海报(付费)→':'🎨 เปลี่ยนเป็นโปสเตอร์ AI ที่กำหนดเอง (เสียเงิน) →', '分享文案':'ข้อความแชร์',
    '分享到微信 / 更多(含海报)':'แชร์ไป WeChat / อื่นๆ (พร้อมโปสเตอร์)', '复制文案':'คัดลอกข้อความ', '复制链接':'คัดลอกลิงก์', '下载海报':'ดาวน์โหลดโปสเตอร์',
    '分享到平台':'แชร์ไปแพลตฟอร์ม', '报名二维码':'QR ลงทะเบียน', '微信 / 相机扫码打开':'สแกนด้วย WeChat / กล้องเพื่อเปิด',
    '电脑上微信分享:扫这个码,或复制链接粘到微信。':'แชร์ WeChat บนคอม: สแกนโค้ดนี้ หรือคัดลอกลิงก์ไปวางใน WeChat', '下载二维码 →':'ดาวน์โหลด QR →',
    '生成海报中…':'กำลังสร้างโปสเตอร์…', '海报已下载 ✓':'ดาวน์โหลดโปสเตอร์แล้ว ✓', '海报生成失败':'สร้างโปสเตอร์ไม่สำเร็จ',
    'AI 海报加载失败':'โหลดโปสเตอร์ AI ไม่สำเร็จ', 'AI 海报':'โปสเตอร์ AI', '暂未开通':'ยังไม่เปิดใช้',
    '🎨 免费生成(固定风格)':'🎨 สร้างฟรี (สไตล์คงที่)', '剩':'เหลือ', '免费:用你的活动名/简介 + 品牌固定画风生成背景。':'ฟรี: ใช้ชื่อ/แนะนำงานของคุณ + สไตล์แบรนด์คงที่สร้างพื้นหลัง',
    '自定义(付费)':'กำหนดเอง (เสียเงิน)', '例:赛博朋克夜景,霓虹紫青配色':'เช่น เมืองไซเบอร์พังก์ยามค่ำ โทนม่วง-ฟ้านีออน',
    '✨ 生成自定义海报':'✨ สร้างโปสเตอร์กำหนดเอง', '恢复模板版':'กลับไปใช้เทมเพลต', '先描述画风':'อธิบายสไตล์ก่อน',
    '生成中,约 15-30 秒…':'กำลังสร้าง ประมาณ 15-30 วินาที…', '返回无效':'ผลลัพธ์ไม่ถูกต้อง', '完成 ✓ 剩 ':'เสร็จ ✓ เหลือ ',
    '宣传海报':'โปสเตอร์ประชาสัมพันธ์', '下载 PNG':'ดาวน์โหลด PNG', '下载 SVG':'ดาวน์โหลด SVG',
    'A4 竖版,用你首页的信息(名称/时间/地点)自动生成。免费可换成 AI 固定画风背景。':'A4 แนวตั้ง สร้างอัตโนมัติจากข้อมูลหน้าแรก (ชื่อ/เวลา/สถานที่) เปลี่ยนเป็นพื้นหลังสไตล์ AI คงที่ได้ฟรี', '导出失败':'ส่งออกไม่สำเร็จ',
    '会':'ทำได้', '找':'หา', '删除':'ลบ', '还没有人发布,来当第一个 👋':'ยังไม่มีใครโพสต์ มาเป็นคนแรก 👋', '删除这张卡片?':'ลบการ์ดนี้?', '加载失败':'โหลดไม่สำเร็จ',
    '发一张卡片:你会什么、想做什么、想找什么样的队友。联系方式会公开显示,方便别人直接找你。':'โพสต์การ์ด: คุณทำอะไรได้ อยากทำอะไร อยากหาเพื่อนร่วมทีมแบบไหน ช่องทางติดต่อจะแสดงสาธารณะให้คนอื่นติดต่อคุณได้ตรง',
    '昵称':'ชื่อเล่น', '联系方式':'ช่องทางติดต่อ', '微信':'WeChat', '我会什么 / 角色':'ฉันทำอะไรได้ / บทบาท', '前端 / 设计 / 合约 …':'ฟรอนต์เอนด์ / ดีไซน์ / สัญญา …',
    '想找什么队友':'อยากหาเพื่อนร่วมทีมแบบไหน', '想做的方向(可选)':'ทิศทางที่อยากทำ (ไม่บังคับ)', '发布':'โพสต์',
    '请填写昵称和联系方式':'กรุณากรอกชื่อเล่นและช่องทางติดต่อ', '已发布,祝你早日找到队友 🎉':'โพสต์แล้ว ขอให้เจอเพื่อนร่วมทีมเร็วๆ 🎉',
    // === batch3: project detail / judge / submit / usage / invites ===
    '试用':'ทดลองใช้', '视频':'วิดีโอ', '更新':'อัปเดต', '打开演示视频':'เปิดวิดีโอเดโม', '返回作品墙':'กลับไปกำแพงผลงาน',
    '查看代码':'ดูโค้ด', '产品截图':'ภาพหน้าจอผลิตภัณฑ์', '点图看大图':'คลิกรูปเพื่อดูภาพใหญ่', '加载 README':'โหลด README',
    '在线试用':'ทดลองใช้ออนไลน์', '在线 Demo':'เดโมออนไลน์', 'Demo 账号':'บัญชีเดโม', 'Demo 密码':'รหัสผ่านเดโม',
    '私有仓库':'ที่เก็บโค้ดส่วนตัว', '仓库':'ที่เก็บโค้ด', '作为协作者可 clone 评估':'clone เพื่อประเมินในฐานะผู้ร่วมงานได้', '点赞':'ถูกใจ',
    '评审版本':'เวอร์ชันตัดสิน', '联系':'ติดต่อ', '语言':'ภาษา', '最后提交':'ส่งครั้งล่าสุด', '官网':'เว็บไซต์ทางการ', '(未提供 README)':'(ไม่มี README)',
    '创新':'นวัตกรรม', '技术':'เทคนิค', '完成度':'ความสมบูรณ์', '展示':'การนำเสนอ', '我的评分':'คะแนนของฉัน', '评语(可选)':'ความเห็น (ไม่บังคับ)',
    '保存评分':'บันทึกคะแนน', '锁定评审版本(记录当前 commit)':'ล็อกเวอร์ชันตัดสิน (บันทึก commit ปัจจุบัน)', '隐藏该作品':'ซ่อนผลงานนี้',
    '已锁定 ':'ล็อกแล้ว ', '确定隐藏该作品?':'ยืนยันซ่อนผลงานนี้?', '本场评委 —— 把他们加为你私有仓库的协作者':'กรรมการงานนี้ — เพิ่มพวกเขาเป็นผู้ร่วมงานในที่เก็บโค้ดส่วนตัวของคุณ',
    '在你的仓库 Settings → Collaborators 逐个添加上面账号,评审期保持,结束后可移除。':'ไปที่ Settings → Collaborators ในที่เก็บโค้ดของคุณ เพิ่มบัญชีข้างต้นทีละคน คงไว้ช่วงตัดสิน เสร็จแล้วลบออกได้',
    '评委名单尚未公布,可先提交,稍后回来加协作者。':'ยังไม่ประกาศรายชื่อกรรมการ ส่งก่อนได้ แล้วค่อยกลับมาเพิ่มผู้ร่วมงาน',
    '提交作品(私密赛)':'ส่งผลงาน (การแข่งส่วนตัว)',
    '私密赛不公开源码:提供在线 Demo + 账号密码给评委体验;代码放 GitHub 私有仓库,把评委加为协作者。':'การแข่งส่วนตัวไม่เปิดซอร์ส: ให้เดโมออนไลน์ + บัญชีรหัสผ่านให้กรรมการทดลอง โค้ดอยู่ในที่เก็บโค้ดส่วนตัว GitHub เพิ่มกรรมการเป็นผู้ร่วมงาน',
    '产品名称':'ชื่อผลิตภัณฑ์', '在线 Demo 链接':'ลิงก์เดโมออนไลน์', '(仅评委可见)':'(เห็นเฉพาะกรรมการ)', '项目 README(粘贴 Markdown)':'README โปรเจกต์ (วาง Markdown)',
    'GitHub 私有仓库链接':'ลิงก์ที่เก็บโค้ดส่วนตัว GitHub', '演示视频链接(可选)':'ลิงก์วิดีโอเดโม (ไม่บังคับ)', '队伍名称(可选)':'ชื่อทีม (ไม่บังคับ)',
    '请填齐带 * 的必填项':'กรุณากรอกช่องที่มี * ให้ครบ', '提交成功!':'ส่งสำเร็จ!', '编辑令牌(改稿用,请保存):':'โทเคนแก้ไข (ใช้แก้ไข โปรดเก็บไว้):',
    '例:帮小区做一个团购小工具…':'เช่น เครื่องมือรวมซื้อสำหรับหมู่บ้าน…',
    '规格已就绪!给作品起个英文名(小写字母/数字/连字符)—— 它同时用作作品名和公有仓库名,AI 就开始建仓 + 编码。':'สเปกพร้อมแล้ว! ตั้งชื่อผลงานเป็นภาษาอังกฤษ (ตัวพิมพ์เล็ก/ตัวเลข/ขีดกลาง) — ใช้เป็นชื่อผลงานและที่เก็บโค้ดสาธารณะ แล้ว AI จะเริ่มสร้างที่เก็บโค้ด + เขียนโค้ด',
    'Mini 赛:不用写代码,交一个作品链接就行 —— no-code 应用 / 网站 / 文档 / 视频都可以。':'การแข่ง Mini: ไม่ต้องเขียนโค้ด แค่ส่งลิงก์ผลงาน — แอป no-code / เว็บ / เอกสาร / วิดีโอ ก็ได้',
    '还没做出来?让 AI 把你的想法直接做成应用':'ยังไม่ได้ทำ? ให้ AI เปลี่ยนไอเดียของคุณเป็นแอปได้เลย', '(可让 AI 帮你写)':'(ให้ AI ช่วยเขียนได้)',
    '最多 ':'สูงสุด ', '先写点想法/简介或链接':'เขียนไอเดีย/แนะนำ หรือใส่ลิงก์ก่อน', '✓ 已填入,可再改':'✓ กรอกแล้ว แก้ไขได้', '点一个填入':'แตะเลือกหนึ่งอันเพื่อใช้',
    '没想出来,再试一次':'คิดไม่ออก ลองอีกครั้ง', '先填作品名或链接':'กรอกชื่อผลงานหรือลิงก์ก่อน', '✓ 可以再改改':'✓ แก้ไขเพิ่มได้', '请填齐作品名、链接、邮箱':'กรุณากรอกชื่อผลงาน ลิงก์ และอีเมลให้ครบ',
    '编辑令牌(改稿用):':'โทเคนแก้ไข (ใช้แก้ไข):',
    '规则:① 视频请传到 <b>B站/YouTube</b>,这里贴链接(别塞进 Git);② 仓库必须 <b>Public</b>,否则评委看不到;③ PPT 放仓库 <code>/docs</code> 里的 <b>PDF</b>(GitHub 可在线预览);④ 截止后建议打 Release tag 锁版本。':'กติกา: ① อัปวิดีโอไปที่ <b>Bilibili/YouTube</b> แล้ววางลิงก์ที่นี่ (อย่าใส่ใน Git); ② ที่เก็บโค้ดต้องเป็น <b>Public</b> ไม่งั้นกรรมการมองไม่เห็น; ③ สไลด์ใส่เป็น <b>PDF</b> ใน <code>/docs</code> ของที่เก็บโค้ด (GitHub พรีวิวออนไลน์ได้); ④ หลังหมดเขตแนะนำติด Release tag เพื่อล็อกเวอร์ชัน',
    '作品的主标题':'หัวข้อหลักของผลงาน', '你的产品 / 作品名':'ชื่อผลิตภัณฑ์ / ผลงานของคุณ', 'GitHub 仓库链接':'ลิงก์ที่เก็บโค้ด GitHub', '必须 Public':'ต้องเป็น Public',
    '演示视频链接':'ลิงก์วิดีโอเดโม', '(B站 / YouTube)':'(Bilibili / YouTube)', '项目亮点 / 技术栈':'จุดเด่นโปรเจกต์ / เทคสแตก', '队伍名称':'ชื่อทีม', '可选':'ไม่บังคับ', '队名':'ชื่อทีม',
    '仅主办方/评委可见,用于联系你':'เห็นเฉพาะผู้จัด/กรรมการ ใช้ติดต่อคุณ', '其他联系方式':'ช่องทางติดต่ออื่น', '可选,如微信':'ไม่บังคับ เช่น WeChat', '微信 / Telegram …':'WeChat / Telegram …',
    ...
    '用量与计费':'การใช้งานและค่าใช้จ่าย', '只读:mini 首场免费,之后按 token 累计待结算。真实用量需 WorkBench 联调后显示。':'อ่านอย่างเดียว: mini งานแรกฟรี หลังจากนั้นสะสมตาม token รอเรียกเก็บ การใช้งานจริงจะแสดงหลังเชื่อมต่อ WorkBench',
    '总 token':'token รวม', '参赛者':'ผู้เข้าแข่ง', '参赛作品':'ผลงานที่ส่ง', '请求':'คำขอ', '暂无用量':'ยังไม่มีการใช้งาน', '产品':'ผลิตภัณฑ์',
    '评委数':'จำนวนกรรมการ', '平均分(满分40)':'คะแนนเฉลี่ย (เต็ม 40)', '未评':'ยังไม่ตัดสิน',
    '每队一个,单次有效。生成后发给各队,选手提交时填。':'ทีมละหนึ่ง ใช้ครั้งเดียว สร้างแล้วส่งให้แต่ละทีม ผู้เข้าแข่งกรอกตอนส่งผลงาน', '生成数量':'จำนวนที่สร้าง', '前缀':'คำนำหน้า', '生成':'สร้าง',
    '已有邀请码':'รหัสเชิญที่มีอยู่', '复制全部未使用':'คัดลอกทั้งหมดที่ยังไม่ใช้', '已生成 ':'สร้างแล้ว ', ' 个,复制发给各队:':' รหัส คัดลอกส่งให้แต่ละทีม:',
    '没有未使用的邀请码':'ไม่มีรหัสเชิญที่ยังไม่ใช้', '已复制 ':'คัดลอกแล้ว ', ' 个 ✓':' รหัส ✓', '共 ':'รวม ', ' 个,未使用 ':' รหัส ยังไม่ใช้ ',
    '评委登录码':'รหัสเข้ากรรมการ', '每个评委一个专属登录码,码绑定姓名,打分身份用码区分(不会同名互相覆盖)。':'กรรมการแต่ละคนมีรหัสเข้าเฉพาะ รหัสผูกกับชื่อ ระบุตัวตนการให้คะแนนด้วยรหัส (ชื่อซ้ำจะไม่ทับกัน)',
    '评委(每行一个:姓名 或 姓名, GitHub)':'กรรมการ (บรรทัดละคน: ชื่อ หรือ ชื่อ, GitHub)', 'GitHub 用于私密赛加协作者':'GitHub ใช้เพิ่มผู้ร่วมงานในการแข่งส่วนตัว',
    '张三, alice-gh&#10;李四, bob-gh':'สมชาย, alice-gh&#10;สมหญิง, bob-gh', '生成登录码':'สร้างรหัสเข้า', '已有评委':'กรรมการที่มีอยู่', '复制全部(姓名+码)':'คัดลอกทั้งหมด (ชื่อ+รหัส)',
  ...
  function renderGuide(){
    ...
    app.innerHTML = '<div class="guide">'
      ...
      // ===== 并列大章节:如何组织一场黑客松 =====
      + '<div class="guide-hero" style="padding:46px 0 6px;border-top:1px solid var(--line);margin-top:18px"><h1>'+t('如何组织一场黑客松','How to Organize a Hackathon')+'</h1>'
  ...
  function renderAbout(){
    ...
    app.innerHTML = '<div class="guide">'
      ...
      + '<img src="/brand/hack5-why-1.png" alt="" loading="lazy" style="width:100%;max-width:520px;display:block;margin:16px auto 6px;border-radius:12px">'
      ...
      + '<img src="/brand/hack5-why-2.png" alt="" loading="lazy" style="width:100%;max-width:520px;display:block;margin:16px auto 6px;border-radius:12px">'
      ...
      + '<img src="/brand/hack5-why-3.png" alt="" loading="lazy" style="width:100%;max-width:520px;display:block;margin:16px auto 6px;border-radius:12px">'
  ...
  function posterSvg(bg, opts){
    ...
    const logoColor = opts.logoColor || '#ffffff';   // poster wordmark (white on the dark poster; the ‹5› mark stays ink-green on its cream chip)
  ...
  function renderShare(){
    ...
    document.querySelectorAll('.shbg').forEach(function(btn){ btn.addEventListener('click', async function(){
      ...
      try{ paintShare(await bgToDataUrl(u)); setMsg('shMsg', t('背景已应用','Background applied')); }
      catch(e){ setMsg('shMsg', t('背景加载失败','Background failed to load'), true); }
    ...
    $('#shPoster').addEventListener('click',async()=>{
      ...
      try{ const b=await posterBlob(shareBg); const u=URL.createObjectURL(b); const a=document.createElement('a'); a.href=u; a.download='hack5-poster.png'; a.click(); setTimeout(()=>URL.revokeObjectURL(u),1000); setMsg('shMsg',t('海报已下载 ✓','Poster downloaded ✓')); }
    ...
    if(hasNative) $('#shNative').addEventListener('click',async()=>{
      ...
      try{ const b=await posterBlob(shareBg); const f=new File([b],'hack5-poster.png',{type:'image/png'}); if(navigator.canShare && navigator.canShare({files:[f]})) data.files=[f]; }catch(e){}
